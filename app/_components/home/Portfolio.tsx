...
const Portfolio = () => {
    ...
    return (
        <div className='relative w-full h-full flex flex-col justify-center items-center bg-[#191A1E]'>
            {/* Spotlight background */}
            <div className="absolute  inset-0 bg-gradient-to-r from-transparent via-[#4191e750] to-transparent animate-spotlight"></div>

            {/* Projects We've Delivered */}
            <div className="flex flex-col justify-center items-center gap-4 mt-4 z-10">
            ...
            <div
                className="relative w-full lg:h-screen h-[42rem] z-10"
