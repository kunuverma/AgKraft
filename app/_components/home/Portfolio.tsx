    ...
    return (
        <div className="w-full h-full flex flex-col gap-10 bg-gradient-to-r from-gray-100 from-10% via-pink-100 via-80% to-slate-200 to-90% p-6 shadow-md">
            ...
            <div className="flex flex-col justify-center items-center gap-4 mt-4">
                ...
                <h1 className='text-[#2A2438] text-xl font-medium text-center'>At AGKraft, our projects reflect our passion for excellence and our ability to bring visions to life.</h1>
            </div>
