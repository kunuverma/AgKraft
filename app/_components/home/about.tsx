...
export const About = () => {
    return (
        <CardSpotlight className="relative flex flex-row items-center justify-center mx-5 sm:mx-10 my-5 gap-9 shadow-[0px_0px_5px_0px_#f7fafc] overflow-hidden">
            {/* Spotlight effect */}
            <div className="absolute  inset-0 bg-gradient-to-r from-transparent via-[#1f528550] to-transparent animate-spotlight"></div>
            <div className='flex flex-col w-full lg:w-[40%] text-left gap-y-5 z-40'>
