  ...
  return (
    <div className="flex flex-col justify-center gap-12 my-5 items-center mx-5 sm:mx-10 bg-[#191A1E] h-full">
      <div className="flex items-center gap-2 sm:gap-3 mt-5">
        ...
        <span className="whitespace-pre-wrap text-left relative z-20 mt-2 bg-clip-text text-3xl sm:text-4xl font-bold leading-none tracking-tighter text-transparent bg-gradient-to-b from-[#ffd319] via-[#ff2975] to-[#8c1eff]">
          Today
        </span>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-36 rounded-xl px-4 md:px-0 mb-5">
        ...
        <form
          ...
          className="p-0 md:p-8 w-full max-w-lg bg-[#1B1C20] text-white rounded-lg shadow-md"
        >
